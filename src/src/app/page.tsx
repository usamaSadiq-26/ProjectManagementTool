...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-950 via-slate-900 to-brand/70 backdrop-blur-3xl">
      <header className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-lg sticky top-0 z-10">
